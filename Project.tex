...
This report is 2,900 words, as counted by running \texttt{detex <report.tex> |
...
recommended that responbility for the software is handed to the University's
...
A database management system (DBMS) is a piece of software that manages the
database, including providing the ability to add or edit records stored in the
database. The DBMS will be one of the more mature products used in the
...
In a presentation at OSCON (The O'Reilly Open Source Convention) in 2007
\cite{raible2007javawebframeworks}, Matt Raible compared several web
frameworks written in Java; JavaServer Faces (JSF), Spring MVC, Stripes,
Struts 2, Tapestry and Wicket.
