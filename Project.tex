...
This report is 10,500 words, as counted by running \texttt{detex} and
...
\begin{figure}[h]
  \begin{center}
    \fbox{\includegraphics[width=0.8\linewidth, trim=5mm 30mm 5mm 5mm]{inc/itservices_nda.pdf}}
  \end{center}
\end{figure}

% \includepdf[pages=-, frame=true]{inc/itservices_nda.pdf}
