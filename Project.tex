...
\ifoptiondraft{
  ...
  \begin{itemize}
    \item Not sure how to refer to myself: ``project implementer'' or ``author'' or ``I''? (I is fine)
    \item Does the structure look ok? (yep, tweaks)
  \end{itemize}
...
The project was also monitored by the \gls{sipig}, a group consisting of
...
services such as the University Library \& Archives and \gls{itservices}.
