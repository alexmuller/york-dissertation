...
This report is 9,300 words, as counted by running \texttt{detex} and
\texttt{wc -w}. It is \pageref{LastPage} pages long. The word count does not
include Appendix~\ref{sec:documentation}.
...
Wherever a member of the University has been quoted by name, their explicit
...
% system, but ultimately it was decided that there was no way in which it was
% possible to give an undergraduate student access to other students' personal
% information.
