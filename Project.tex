...
\usepackage{color} % Syntax highlighting etc
...
These four lines of code generates a Java class representing a student, 500
...
% JSP, Tiles, Freemarker, Velocity, iText PDF, JExcel, Jasper Reports, and
% XSLT are all supported by Spring
