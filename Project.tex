...
Figures~\ref{paperformarchaeology1} and [@todo History] show paper forms used
by each of the pilot departments to allow students to rank their modules in
order of preference.
...
\begin{figure}
  ...
  \end{center}
  \caption{A paper form given to Archaeology students to select their modules}
