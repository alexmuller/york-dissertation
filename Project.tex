...
using Django and constrained optimisation}
...
This report is 11,700 words, as counted by running \texttt{detex} and
...
% The author is very grateful for the assistance provided by all the staff and
% students at the University of York who were involved in the project, and
% especially to James Cussens for his advice throughout and Laura Crossley for
% her management of the project on behalf of the University.
...
\ifoptiondraft{
  ...
  \begin{itemize}
    ...
    \item Not sure how to refer to myself: ``project implementer'' or ``author'' or ``I''?
    \item Does the structure look ok?
    \item Should the title be changed? Something about a web application?
    \item Gantt chart?
  \end{itemize}
  
  % Git revision: 2ac757a362375cafd6b8d543e01d6810265f91ad
...
Information from departments that informed the allocation problem is given,
and the process surrounding the allocation is discussed.
...
% Associate in the \gls{hci} research group at the University of York.
...
The project implementer met with a member of \gls{ssdt} during the research
...
% work or could be improved - this shows learning from the experience.

% This section should be a summary of everything you have done with your
% personal comments and findings and perhaps some discussion on whether you
% agree with the references you cited.

% It became apparent during implementation that there were areas that should
% have been researched more thoroughly, primarily database theory. This was
% not helped by my unfamiliarity with the framework and associated tools,
% which was creating the database structure from the entities defined.
...
\section{Confidentiality and non-disclosure agreement}
\label{sec:nda}
