...
This report is 6,500 words, as counted by running \texttt{detex} and
...
% In the History student focus group, it became immediately clear that the
% two-column layout was the easiest to use and related to students' existing
% mental model most closely.
...
% I was unfamiliar with the framework which made it hard to estimate whether
% the software would be finished on time. If I was doing this project again,
% I might first use a language I was familiar with to prototype, and then
% implement in a language good for ITS. This means 2x implementation work,
% but would be much more relaxed.
